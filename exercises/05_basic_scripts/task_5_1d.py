...
device = input("Имя устройства: ")

device = device.lower()

parampromt = f"Ввести имя параметра: ({", ".join(london_co[device].keys())})"

params = input(parampromt)

params = params.lower()

dev_var = london_co[device]

print(dev_var.get(params, 'Неизвестный параметр'))